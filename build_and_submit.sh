...
$path_to_spark/bin/spark-submit --conf spark.eventLog.enabled=true --conf spark.eventLog.dir="/tmp" --driver-memory 10g --class com.sparkProject.$1 $master_ip target/scala-2.11/*.jar $args
